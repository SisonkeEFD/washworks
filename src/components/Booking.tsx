      ...
      <div className="max-w-7xl mx-auto">
        <motion.div initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="text-center mb-12">
          ...
          <p className="mt-4 text-white/[0.45] font-body max-w-2xl mx-auto">
            Fill in your details below and we'll confirm your booking via WhatsApp within the hour. No fuss, no stress — just clean laundry delivered back to your door.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-3 bg-white/[0.05] backdrop-blur-[16px] border border-white/[0.1] rounded-[20px] p-8 sm:p-10">
              ...
              {[1, 2, 3].map((s) => (
                <div key={s} className="flex items-center">
                  <div className={`w-9 h-9 rounded-full flex items-center justify-center text-sm font-body font-bold ${
                    step > s ? "bg-blue-primary text-white" : step === s ? "bg-blue-bright text-white" : "border-2 border-white/30 text-white/30"
                  }`}>
                    {step > s ? "✓" : s}
                  </div>
            ...
            {submitted ? (
              <div className="text-center py-10">
                ...
                <h3 className="font-display font-bold text-white text-xl">🎉 Booking Requested!</h3>
                  ...
                  <div>
                    ...
                    <div className="max-w-sm mx-auto">
                      <div className="flex items-center justify-between mb-4">
                        ...
                        <span className="font-display font-bold text-white text-[1.1rem]">{months[viewMonth]} {viewYear}</span>
                        <button onClick={nextMonth} className="text-white text-xl px-2 hover:opacity-70">›</button>
                      </div>
                      <div className="grid grid-cols-7 gap-1 mb-2">
                        {dayNames.map((d) => (
                          <div key={d} className="text-center text-white/50 font-body font-medium text-xs py-1">{d}</div>
                        ))}
                      </div>
                        ...
                        {Array.from({ length: daysInMonth }).map((_, i) => {
                          ...
                          return (
                            <button
                              ...
                              className={`w-10 h-10 rounded-lg font-body font-semibold text-sm flex items-center justify-center transition-all ${
                    ...
                    {selectedDate && (
                      <button onClick={() => setStep(2)} className="mt-6 bg-blue-bright text-white font-body font-bold px-6 py-3 rounded-lg w-full">
                        Next →
                      </button>
                    )}
                  </div>
                  ...
                  <div>
                    ...
                    <div className="mt-6 flex gap-3">
                      ...
                      <button
                        ...
                        className="bg-blue-bright text-white font-body font-bold px-6 py-3 rounded-lg flex-1 disabled:opacity-40"
                      >
                        Next →
                      </button>
                    </div>
                ...
                {step === 3 && (
                  <div>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        ...
                        <div>
                          ...
                          <select className={inputClass()} value={form.basket} onChange={(e) => setForm({ ...form, basket: e.target.value })}>
                            <option value="">Select...</option>
                    ...
                    <div className="mt-6 flex gap-3">
                      ...
                      <button onClick={handleSubmit} className="bg-blue-bright text-white font-body font-bold py-4 rounded-lg flex-1 hover:-translate-y-[2px] transition-transform text-base">
                        ✅ Confirm My Pickup
                      </button>
                    </div>
                  </div>
          ...
          <div className="lg:col-span-2">
            <h3 className="font-display font-bold text-white text-[1.5rem] mb-8">We Make it Easy to Get Started</h3>

            <div className="space-y-6">
              {[
                { icon: "⏰", title: "Operating Hours", desc: "Monday to Friday: 8am – 6pm | Saturday: 9am – 2pm | Sunday: Closed" },
                { icon: "📍", title: "Collection Area", desc: "Centurion and all surrounding suburbs including Wierdapark, Eldoraigne, Rooihuiskraal, Midstream, Highveld, Lyttelton and more." },
                { icon: "💬", title: "WhatsApp", desc: "Message us directly on 079 638 8572 to book or ask any questions." },
                { icon: "✉️", title: "Email", desc: "info@thewashworks.co.za" },
              ].map((item) => (
                <div key={item.title} className="flex gap-4">
                  <div className="w-11 h-11 bg-[rgba(37,99,235,0.2)] rounded-[10px] flex items-center justify-center text-lg flex-shrink-0">
                    {item.icon}
                  </div>
                  <div>
            ...
            <a
              ...
              className="mt-8 block w-full text-center bg-green-wa text-white font-body font-bold py-4 px-7 rounded-lg shadow-[0_8px_30px_rgba(37,211,102,0.3)] hover:-translate-y-[2px] transition-transform"
            >
              💬 Book via WhatsApp
            </a>
