...
const Corporate = () => (
  <section id="corporate" className="section-padding px-4 bg-warm-bg">
    <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
      ...
      >
        ...
        <p className="mt-4 text-white/50 font-body leading-relaxed">
          We build tailored packages with discounted staff rates, dedicated collection schedules and a service level built around your business needs. Every business is different and your laundry solution should be too.
        </p>
        <a
          ...
          className="mt-8 w-full inline-flex items-center justify-center gap-2 bg-blue-bright text-white font-body font-bold py-4 rounded-lg hover:bg-[#1d4ed8] hover:-translate-y-[2px] hover:shadow-[0_8px_24px_rgba(37,99,235,0.35)] transition-all"
        >
