    ...
    >
      ...
      <div className="relative z-[2] w-full max-w-7xl mx-auto px-[5%] pt-32 pb-20 flex items-center">
        ...
        <div className="max-w-[700px] max-lg:mx-auto max-lg:text-center">
          ...
          >
            Professional wash and fold, ironing and sneaker cleaning, with convenient collection and delivery throughout Centurion, Riversands, Raslouw, Copperleaf, Eldoraigne and surrounding areas.
          </motion.p>
