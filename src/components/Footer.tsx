    ...
    <div className="max-w-7xl mx-auto">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-[2fr_1fr_1fr_1fr] gap-10">
        ...
        <div>
          ...
          {["Centurion", "Riversands", "Riverside View", "Raslouw", "Laudium", "Christoburg"].map((a) => (
        ...
        <div>
          ...
          <a href="mailto:thewashworkslaundry@gmail.com" className="flex items-center gap-2.5 font-body text-[0.83rem] text-white/40 hover:text-blue-light mb-[10px] transition-colors break-all">
            <Mail size={16} className="text-blue-light flex-shrink-0" /> thewashworkslaundry@gmail.com
          </a>
      ...
      <div className="mt-12 pt-6 border-t border-white/[0.06] flex flex-col sm:flex-row justify-between items-center gap-2">
        <p className="font-body text-[0.77rem] text-white/30">
          &copy; 2026 The Wash Works Laundromat & Sneaker Care · Centurion, Gauteng · All rights reserved.
        </p>
