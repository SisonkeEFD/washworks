...
const faqs = [
  ...
  { q: "How long does laundry take from pickup to delivery?", a: "Most standard laundry orders are turned around within 24–48 hours. We'll confirm your delivery window when we collect. Urgent requests? WhatsApp us directly." },
  ...
  { q: "How do I know which basket size I need?", a: "XSmall = 1–2 outfits · Small = a couple of days of clothing · Medium = a full week for 1–2 people · Large = a family's weekly wash. Not sure? We're happy to advise via WhatsApp." },
];
